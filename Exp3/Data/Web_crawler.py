...
def lab3_get_content(html):
     ...
     for each_content in content:
          ...
          print(time[time_count].contents[0])
          data.append([time[time_count].contents[0],result_content,result_url])
...
"""
    ...
    certain_url="https://github.com/microsoft/vscode/issues/66418"
    certain_html=get_html(certain_url)
    lab3_get_content(certain_html)
